  ...
  async loadBlockchainData() {
    ...
    if (networkData) {
      ...
      for (let j = 1; j <= cCount; j++) {
        ...
        if (
          (certificate.issuer === this.state.account ||
            certificate.recipient === this.state.account) &&
          certificate.isValid
        ) {
          this.setState({
          ...
          <Route
            ...
            render={(props) => (
              <React.Fragment>
                {this.state.loading ? (
                  <div class="center">
                    <HalfCircleSpinner size="100" color="black" />
                  </div>
                ) : (
                  <Home
              ...
              <React.Fragment>
                {this.state.loading ? (
                  ...
                  <Certificate
                    users={this.state.users}
                    account={this.state.account}
                    myCertificates={this.state.myCertificates}
