              ...
              {this.props.myCertificates.map((cert, key) => {
                return (
                  <Card>
                    ...
                    <Card.Body>
                      <Card.Text>Recipient Address: {cert.recipient}</Card.Text>
                      <Card.Text>{cert.desc}</Card.Text>
                      <a
                        href={cert.url}
                        target="_blank"
                        rel="noopener noreferrer"
                      >
                        <p class="badge badge-primary">View Certificate</p>
                      </a>
                      <br />
                      <br />
                      <Button
              ...
              {this.props.myCertificates.map((cert, key) => {
                return (
                  <Card>
                    <Card.Header>Certificate ID: {cert.uid}</Card.Header>
                    <Card.Body>
                      <Card.Text>Issuer Address: {cert.issuer}</Card.Text>
                      <Card.Text>{cert.desc}</Card.Text>
                      <a
                        href={cert.url}
                        target="_blank"
